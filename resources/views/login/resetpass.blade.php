    ...
    <style>
        * {
        ...
        body {
            ...
            min-height: 100vh;
            background: linear-gradient(135deg, #ffffffff 0%, #eccc74 100%);
            display: flex;
            align-items: center;
        ...
        .back-button::after {
            ...
            width: 0;
            height: 2px;
            background: linear-gradient(90deg, #eccc74, #eccc74);
        ...
        .submit-btn {
            width: 100%;
            padding: 16px;
            background: linear-gradient(135deg, #eccc74, #26c6da);
            color: white;
            border: none;
            border-radius: 15px;
            font-size: 1.1rem;
            ...
            margin-top: 10px;
            opacity: 0;
            animation: slideUp 0.6s ease-out 2.2s forwards;
            display: flex;
            align-items: center;
            justify-content: center;
        }
        ...
        .success-message {
            background: linear-gradient(135deg, #eccc74, #eccc74);
            color: white;
        }

        .error-message {
            background: linear-gradient(135deg, #eccc74, #dc2626);
            color: white;
        }
            ...
            <div class="header">
                <div class="icon-container">
                    ...
                    <svg class="lock-icon" viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
                        <rect x="30" y="45" width="40" height="35" rx="5" fill="url(#lockGradient)" stroke="#eccc74" stroke-width="2" />
                        <path d="M 40 45 L 40 30 Q 40 20 50 20 Q 60 20 60 30 L 60 45" fill="none" stroke="#eccc74" stroke-width="3" stroke-linecap="round" />
